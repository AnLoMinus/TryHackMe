...
- [x] [Burp Suite: Repeater](https://tryhackme.com/jr/burpsuiterepeater)
  - Learn how to use Repeater to duplicate requests in Burp Suite
      - [x] Task 1  `Introduction` Outline
      - [x] Task 2  `Repeater` What is Repeater?
      - [x] Task 3  `Repeater` Basic Usage
      - [x] Task 4  `Repeater` Views
      - [x] Task 5  `Repeater` Inspector
      - [x] Task 6  `Practical` Example
      - [x] Task 7  `Practical` Challenge
      - [x] Task 8  `Extra` Mile SQLi with Repeater
      - [x] Task 9  `Conclusion` Room Conclusion
...
- [x] [Burp Suite: Intruder](https://tryhackme.com/jr/burpsuiteintruder)
  - Learn how to use Intruder to automate requests in Burp Suite
      - [x] Task 1  `Introduction` Room Outline
      - [x] Task 2  `Intruder` What is Intruder?
      - [x] Task 3  `Intruder` Positions
      - [x] Task 4  `Attack` Types Introduction
      - [x] Task 5  `Attack` Types Sniper
      - [x] Task 6  `Attack` Types Battering Ram
      - [x] Task 7  `Attack` Types Pitchfork
      - [x] Task 8  `Attack` Types Cluster Bomb
      - [x] Task 9  `Intruder` Payloads
      - [x] Task 10  `Practical` Example
      - [x] Task 11  `Practical` Challenge
      - [x] Task 12  `Extra` Mile CSRF Token Bypass
      - [x] Task 13  `Conclusion` Conclusion

- [x] [Burp Suite: Other Modules](https://tryhackme.com/jr/burpsuiteom)
  - Take a dive into some of Burp Suite's lesser known modules
      - [x] Task 1  `Introduction` Outline
      - [x] Task 2  `Decoder` Overview
      - [x] Task 3  `Decoder` Encoding/Decoding
      - [x] Task 4  `Decoder` Hashing
      - [x] Task 5  `Comparer` Overview
      - [x] Task 6  `Comparer` Example
      - [x] Task 7  `Sequencer` Overview
      - [x] Task 8  `Sequencer` Live Capture
      - [x] Task 9  `Sequencer` Analysis
      - [x] Task 10  `Conclusion` Room Conclusion
...
- [x] [Burp Suite: Extender](https://tryhackme.com/jr/burpsuiteextender)
  - Learn how to use Extender to broaden the functionality of Burp Suite
      - [x] Task 1  `Introduction` Outline
      - [x] Task 2  `Extender` The Extender Interface
      - [x] Task 3  `Extender` The BApp Store
      - [x] Task 4  `Extender` Jython
      - [x] Task 5  `Extender` The Burp Suite API
      - [x] Task 6  `Conclusion` Room Conclusion
...
![image](https://user-images.githubusercontent.com/51442719/172671036-28090dd7-b737-427e-a2de-3687d0cbd503.png)
- [ ] [Upload Vulnerabilities](https://tryhackme.com/room/uploadvulns) [*](https://github.com/Anlominus/TryHackMe/tree/main/Learning%20Path/Web%20Fundamentals/Web%20Hacking%20Fundamentals/Upload%20Vulnerabilities)
